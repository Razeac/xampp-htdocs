...
if(isset($_POST['submit'])){
	...
	$obj=new DbFunction();
	$obj->create_section($_POST['course-short'],$_POST['cdate']);
							...
							<div class="row">
						 	<div class="col-lg-10">
										...
										<div class="form-group">
											<div class="col-lg-4">
					 <label>Section Name<span id="" style="font-size:11px;color:red">*</span>	</label>
											</div>
											<div class="col-lg-6">
  ...
  <input class="form-control" name="course-short" id="cshort" required="required"  onblur="courseAvailability()">       
	...
	<input class="form-control" value="<?php echo date('d-m-Y');?>" readonly="readonly" name="cdate">
		...
		<br><br>		
							...
							<input type="submit" class="btn btn-primary" name="submit" value="Create Section"></button>
											</div>
